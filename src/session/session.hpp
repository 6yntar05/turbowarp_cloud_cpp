...
public:
    struct handlers {
        ...
        handler<context, std::tuple<size_t /*bytes_transferred*/, asio::const_buffer>,
        ...
        handler<context, std::tuple<size_t /*bytes_transferred*/>,
                std::tuple<size_t /*bytes_transferred*/, const beast::error_code &>>
            on_write = {
...
public:
    ...
    void send(const asio::const_buffer &data,
